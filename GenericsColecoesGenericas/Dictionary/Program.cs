...
Dictionary<int, Aluno> dicionarioAlunos = new()
{
    {1, new("Maria",7)},
    {2, new("Eric",8)},
    {3, new("Ana",9)},
...
foreach (var dicionarioItem in dicionarioAlunos)
{
    Console.WriteLine($"{dicionarioItem.Value.Nome} {dicionarioItem.Value.Nota}");
}

dicionarioAlunos[5].Nota = 10;

dicionarioAlunos.Remove(1);
dicionarioAlunos.TryAdd(1, new("Vilva", 7));

var dicionarioOrdenado = dicionarioAlunos.OrderBy(dicionario => dicionario.Value.Nome);

dicionarioAlunos.Clear();
