...
Pessoa pessoaMaisVelha2 = listaDePessoas.Aggregate((p1, p2) => p1.Idade > p2.Idade ? p1 : p2);
Console.WriteLine("A pessoa mais velha é: " + pessoaMaisVelha2.Nome + " " + pessoaMaisVelha2.Idade);
